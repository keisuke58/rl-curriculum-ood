...
\newcommand{\CONVRND}{\textcolor{red}{[RND-step]}}
\newcommand{\CONVREW}{\textcolor{red}{[reward-step]}}
\newcommand{\CONVSAVE}{\textcolor{red}{[XX\%]}}
...
final reward. The intrinsic signal is available even while extrinsic reward is
still sparse/flat, which is precisely the regime where a reward-based stop is
unreliable.
