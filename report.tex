...
multi-task RL via adaptive task sampling~\citep{robust-multitask-arxiv26} formalizes exactly
this---up-weighting the currently hardest task while retaining the others---and is a natural
next step that should combine the controllability of a curriculum with the anti-forgetting
